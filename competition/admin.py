...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('name', 'text', 'registration', 'finish')

    readonly_fields = ('uuid', 'qr_code', 'link')

    def get_fields(self, request, obj=None):
        if obj:
            return 'name', 'text', 'youtube_link', 'registration', 'finish', 'qr_code', 'link'
        else:
            return 'name', 'text', 'youtube_link', 'registration', 'finish'
...
class TimeAdmin(admin.ModelAdmin, ExportCsvMixin):
    list_display = ('created', 'player_nickname', 'player_uuid', 'category', 'task')
    fields = ('created', 'player_nickname', 'player_uuid', 'category', 'task')
